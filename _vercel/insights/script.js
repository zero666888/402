    ...
    i(),
      (function () {
        let t = (e) => e,
          ...
          a = n.currentScript,
          r =
            (null == a ? void 0 : a.dataset.endpoint) ||
            (null != a && a.src.includes("/va/") ? "/va" : "/_vercel/insights"),
        ...
        async function u(e) {
          ...
          let r = new URL(a.src);
          return (
            (r.pathname = r.pathname.replace("/script.js", "/flags/script.js")),
        ...
        async function c({ type: i, data: s, options: c }) {
          ...
          let h = e(l),
            v = n.referrer,
            w = t({ type: i, url: h, payload: s });
          if (!1 === w || null === w) return;
          w && ((h = w.url), (s = null != (d = w.payload) ? d : s));
          let y = v.includes(location.host),
            g = {
              o: h,
              sv: "0.1.3",
              sdkn:
                null != (p = null == a ? void 0 : a.dataset.sdkn) ? p : void 0,
              sdkv:
                null != (f = null == a ? void 0 : a.dataset.sdkv) ? f : void 0,
              ts: Date.now(),
              ...(o && { dp: o }),
              ...(null != c && c.withReferrer && !y ? { r: v } : {}),
              ...("event" === i && s && { en: s.name, ed: s.data }),
        ...
        async function f() {
          await fetch(`${r}/session`, { method: "GET", keepalive: !0 }).catch(
            () => {}
          );
        }
        function h(e) {
